  ...
  return (
    <div>
      <Grid container direction={"column"} justifyContent={"center"} alignItems={"center"}>
        ...
        <h1 style={{textAlign:"center"}}>Supervisor Dasboard</h1>
            ...
            <Box sx={{ width: '100%' }}>
              <Box sx={{ bgcolor: 'transparent' }}>
                ...
                <TabPanel value={value} index={0}>
                  <ApprovalListAccordion></ApprovalListAccordion>
                </TabPanel>
                <TabPanel value={value} index={1}>
                  <SupervisorApprovedTableDisplay></SupervisorApprovedTableDisplay>
                </TabPanel> 
