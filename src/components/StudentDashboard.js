...
import StatusTableDisplay from './StatusTableDisplay';
      ...
      <Grid container direction={"column"} justifyContent={"center"} alignItems={"center"}>
        ...
        <Grid item  sx={{background:"#E2E8EC"}} width={"90%"} height="auto">
          <Stack alignItems={"center"} spacing={6}>
            <div style={{width:"70%"}}>
              <p className='std-dash-txt'>
                Hello UserName,<br></br>
                Welcome to the dashboard, here you can seek for the approval for your research and check the status of your approval
              </p>
              <Divider ></Divider>
            </div>
            
            <div style={{width:"80%",paddingBottom:"2em"}}>
            <Box sx={{ width: '100%' }}>
              <Box sx={{ bgcolor: 'transparent' }}>
                <AntTabs value={value} onChange={handleChange} aria-label="ant example">
                  <AntTab label="Approval Form " />
                  <AntTab label="Status" />
                </AntTabs>
                ...
                <TabPanel value={value} index={1}>
                  <StatusTableDisplay>s</StatusTableDisplay>
                </TabPanel> 
